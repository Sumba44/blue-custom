...
{block name='content'}
  ...
  <section id="main">
        ...
        <div class="col-md-6">
          {block name='page_header_container'}
            {block name='page_header'}
              <h2 class="main-heading">{block name='page_title'}{$product.name}{/block}</h2>
            {/block}
          {/block}
    ...
    <div class="card-block mt-4">
      <h2>{l s='About the brand' d='Shop.Theme.Catalog'}</h2>
      <a href="{$base_dir}index.php?id_manufacturer={$product->id_manufacturer}&controller=manufacturer&id_lang={Tools::getValue('id_lang')}">
        <img src="/img/m/{$product->id_manufacturer}-medium_default.jpg" alt="{Manufacturer::getNameById($product->id_manufacturer)}" title="{Manufacturer::getNameById($product->id_manufacturer)}">
      </a>
      <a href="{$base_dir}index.php?id_manufacturer={$product->id_manufacturer}&controller=manufacturer&id_lang={Tools::getValue('id_lang')}">
        <h2>{$product_manufacturer->name}</h2>
      </a>
